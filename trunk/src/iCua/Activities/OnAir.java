...
public class OnAir extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      mIsBound = true;
        ...
        btnext.setOnClickListener(lnext);
...
//	txt.setText(saux.artist +" - " +saux.title );
	int id_album = mSecondaryService.getIdAlbum();
	File faux = new File("/sdcard/iCua/art/album/"+ id_album+".jpg");
     if (faux.exists())
     {
    	 img.setImageBitmap(BitmapFactory.decodeFile("/sdcard/iCua/art/album/"+ id_album+".jpg"));
    	  
     }else{
    	 id_album = mSecondaryService.getIdArtist();
    	 faux = new File("/sdcard/iCua/art/artist/"+id_album +".jpg");
    	 if (faux.exists())
    	 {
    		 img.setImageBitmap(BitmapFactory.decodeFile("/sdcard/iCua/art/artist/"+id_album +".jpg"));
     	 }else{
