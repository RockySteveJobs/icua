...
static final int TRANSACTION_seekSong = (IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_SetPlaylist = (IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_isPlaying = (IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_basicTypes = (IBinder.FIRST_CALL_TRANSACTION + 14);
}
/**
     * Request the PID of this service, to do evil things with it.
     */
